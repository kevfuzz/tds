...
describe('OverviewScreen', () => {
  ...
  it('navigate() opens the VAT3 form in the forms app', () => {
    ...
    expect(spy).toHaveBeenCalledWith(
      expect.objectContaining({ appId: 'forms', path: '/vat3', customer: FIXTURE_CUSTOMER }),
    );
  });

  it('setDirty demo flips both local state and the workbench dirty flag', () => {
    const wb = TestBed.inject(Workbench);
    const spy = vi.spyOn(wb, 'setDirty');

    const fixture = TestBed.createComponent(OverviewScreen);
    fixture.detectChanges();
    fixture.componentInstance.toggleDirty();
